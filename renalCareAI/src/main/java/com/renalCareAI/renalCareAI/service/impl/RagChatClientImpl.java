...
import com.renalCareAI.renalCareAI.common.RagServiceException;
...
@Service
public class RagChatClientImpl implements RagChatClient {
    private static final Logger log = LoggerFactory.getLogger(RagChatClientImpl.class);

    private final WebClient webClient;

    public RagChatClientImpl(RagProcessProperties properties) {
